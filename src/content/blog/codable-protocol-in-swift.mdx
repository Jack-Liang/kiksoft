...
The `Codable` protocol <Notation type="underline" color="green">allows developers to encode or decode instances of a type to and from variety formats</Notation>, such as a JSON or property lists.
